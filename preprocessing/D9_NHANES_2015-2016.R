...
# Objective           : Reading and cleaning NHANES 2015-2016
# Owner               : Jithin
...
#
# Modules :
#     1. Reading and cleaning NHANES 2015-2016 data for Whites
#----------------------------------------------------------------------------
...
# 1. Reading and cleaning NHANES 2015-2016 data ----------------
path_data <- "D:/St John's National Academy of Health Sciences/Data Science - 22_Evaluating Hb cutoffs/data"

cbc <- sasxport.get(paste0(path_data,"/nhanes/CBC_I.XPT"),allow=FALSE,as.is=TRUE)
demo <- sasxport.get(paste0(path_data,"/nhanes/DEMO_I.XPT"),allow=FALSE,as.is=TRUE)
hsq <- sasxport.get(paste0(path_data,"/nhanes/HSQ_I.XPT"),allow=FALSE,as.is=TRUE)
huq <- sasxport.get(paste0(path_data,"/nhanes/HUQ_I.XPT"),allow=FALSE,as.is=TRUE)
biopro <- sasxport.get(paste0(path_data,"/nhanes/BIOPRO_I.XPT"),allow=FALSE,as.is=TRUE)
...
write.xlsx(as.data.frame(df),
           ...
           sheetName = "2015-2016",append=TRUE,row.names=FALSE)

saveRDS(df,file=paste0(path_data , "/working/nhanes_2015to2016_v2.RDS"))
